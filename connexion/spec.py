...
def create_validate_default_fn(instance_validator: Draft4Validator) -> t.Callable:
    ...
    Args:
        instance_validator: A validator to validate defaults against the openapi spec itself
                            instead of against the openapi schema.

    Returns:
        A validation function for property defaults using the passed in instance_validator
